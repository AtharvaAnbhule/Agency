      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:hello@stratixco.com" className="hover:text-primary transition-colors">
                    hello@stratixco.com
                  </a>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <CardContent>
                <Form {...newsletterForm}>
                  <form onSubmit={newsletterForm.handleSubmit(onSubscribeNewsletter)} className="flex gap-2">
                    ...
                    />
                    <Button type="submit" size="sm" disabled={isSubscribing} className="px-6">
                      {isSubscribing ? (
                        <motion.div
                          animate={{ rotate: 360 }}
        ...
        <div className="py-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            <span>© {year} Stratix Co. Solutions. All Rights Reserved . </span>
