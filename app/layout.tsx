...
export const metadata: Metadata = {
  title: 'Stratix Co. Solutions - AI-Powered Digital Innovation',
  ...
  authors: [{ name: 'Stratix Co. Solutions' }],
  creator: 'Stratix Co. Solutions',
  publisher: 'Stratix Co. Solutions',
  robots: 'index, follow',
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://Stratix Co.-solutions.com',
    title: 'Stratix Co. Solutions - AI-Powered Digital Innovation',
    description: 'Empowering Digital Growth with Scalable Tech Solutions',
    siteName: 'Stratix Co. Solutions',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Stratix Co. Solutions - AI-Powered Digital Innovation',
    description: 'Empowering Digital Growth with Scalable Tech Solutions',
    creator: '@Stratix Co._solutions',
  },
};
